      ...
      <div className="relative z-20 flex flex-col items-center justify-center w-full max-w-sm px-8 min-h-[500px] pointer-events-none pb-4">
        ...
        >
          ...
          <div className="text-center space-y-1">
             <h1 className="text-xl font-serif text-stone-800 dark:text-stone-200 font-bold tracking-widest uppercase">Weekly Polaroid</h1>
             <p className="text-xs font-sans text-stone-500 dark:text-stone-400 tracking-widest uppercase">Moments in Time</p>
          </div>
        </motion.div>
